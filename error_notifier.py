...
class ErrorType(Enum):
    ...
    RESEND_SEND_FAILED = ("critical", "fire,envelope,x")
    RESEND_UNAUTHORIZED = ("critical", "fire,key,x")
    RESEND_FORBIDDEN = ("critical", "fire,no_entry,envelope")
    RESEND_RATE_LIMITED = ("api_keys", "envelope,pause_button,warning")
    RESEND_DAILY_QUOTA_EXCEEDED = ("api_keys", "envelope,calendar,x")
    RESEND_MONTHLY_QUOTA_EXCEEDED = ("api_keys", "envelope,hourglass,x")
    RESEND_VALIDATION_ERROR = ("api_keys", "envelope,question,x")
    RESEND_SERVER_ERROR = ("critical", "fire,envelope,skull")

    BREVO_BAD_REQUEST = ("api_keys", "envelope,x,question")
    BREVO_UNAUTHORIZED = ("critical", "fire,key,x")
    BREVO_PAYMENT_REQUIRED = ("critical", "fire,envelope,moneybag")
    BREVO_FORBIDDEN = ("api_keys", "envelope,no_entry")
    BREVO_NOT_FOUND = ("api_keys", "envelope,mag,x")
    BREVO_QUOTA_EXCEEDED = ("api_keys", "envelope,hourglass,warning")
    BREVO_ACCOUNT_SUSPENDED = ("critical", "fire,envelope,rotating_light")
    BREVO_FALLBACK_TO_RESEND = ("api_keys", "envelope,arrows_counterclockwise")

    MAILTRAP_BAD_REQUEST = ("api_keys", "envelope,x,question")
    MAILTRAP_UNAUTHORIZED = ("critical", "fire,key,x")
    MAILTRAP_FORBIDDEN = ("api_keys", "envelope,no_entry")
    MAILTRAP_RATE_LIMITED = ("api_keys", "envelope,pause_button,warning")
    MAILTRAP_SERVER_ERROR = ("critical", "fire,envelope,skull")
    MAILTRAP_FALLBACK_TO_RESEND = ("api_keys", "envelope,arrows_counterclockwise")

    LOOPS_BAD_REQUEST = ("api_keys", "envelope,x,question")
    LOOPS_UNAUTHORIZED = ("critical", "fire,key,x")
    LOOPS_NOT_FOUND = ("critical", "fire,envelope,mag")
    LOOPS_CONFLICT = ("api_keys", "envelope,arrows_counterclockwise,warning")
